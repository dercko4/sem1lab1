...
const Manufacturer = sequelize.define('manufacturers', {
  id_manufacturer: {type: DataTypes.UUID, primaryKey: true, defualtValue: UUIDV4},
  contry: {type: DataTypes.STRING},
  name_of_organization: {type: DataTypes.STRING}
})

const Warehouse = sequelize.define('warehouses', {
  id_warehouse: {type: DataTypes.UUID, primaryKey: true, defualtValue: UUIDV4},
  address: {type: DataTypes.STRING},
  capacity: {type: DataTypes.INTEGER}
})

const Category = sequelize.define('categories', {
  id_category: {type: DataTypes. UUID, primaryKey: true, defualtValue: UUIDV4},
...
const Product = sequelize.define('products',{
  id_product: {type: DataTypes.UUID, primaryKey: true, defualtValue: UUIDV4},
...
const Basket_Product = sequelize.define('basket_products', {
  id_basket: {type: DataTypes.UUID, primaryKey: true, defualtValue: UUIDV4},
  id_product: {type: DataTypes.UUID, references: {model: Product, key: 'id_product'}},
  quantity_to_buy: {type: DataTypes.INTEGER}
})

const Order = sequelize.define('orders', {
  id_order: {type: DataTypes. UUID, primaryKey: true, defualtValue: UUIDV4},
